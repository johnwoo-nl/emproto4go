...
To log in, set a password like this, specifying the serial of the EVSE you want to lo gin to and the 6-digit password:
```terminaloutput
clitest.exe 0123456789ABCDEF=123456
```
Once logged in, you'll see more detailed info about the EVSE. Logging in is also required to start/stop charging sessions.
